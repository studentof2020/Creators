...
function cal()
{
    ...
    if(a1==0.11 && a2==0.22 && a3==0.33 && a4==0.44)
    {
        ...
        alert("wrong  Hint:0.11,0.22,0.33&0.44");
}
function ob1()
{
...
function ob3(){
    var xx=document.getElementById('l21').value;
    if(xx==6.4){
        document.getElementById('l22').innerHTML="CONGRATULATIONS !!!!You have successfully completed the experiment";
    }
    else{
        document.getElementById('l22').innerHTML="Wrong Answer! Try again";
    }
}
